controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    SPIRIPALLINO = sprites.createProjectileFromSprite(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . 6 6 6 6 . . . . . . 
        . . . . 6 6 6 5 5 6 6 6 . . . . 
        . . . 7 7 7 7 6 6 6 6 6 6 . . . 
...
let GRAZIE_GIBBO_PER_LEDITING: Sprite = null
let SPIRIPALLINO: Sprite = null
let AEREOCOSO_BLUU: Sprite = null
...
AEREOCOSO_BLUU = sprites.create(img`
    ........................
    ........................
    ........................
    ........................
    ...
    ........................
    `, SpriteKind.Player)
AEREOCOSO_BLUU.setFlag(SpriteFlag.StayInScreen, true)
info.setLife(3)
controller.moveSprite(AEREOCOSO_BLUU, 200, 200)
game.onUpdateInterval(500, function () {
    GRAZIE_GIBBO_PER_LEDITING = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . b 5 b . . . 
        . . . . . . . . . b 5 b . . . . 
        . 3 . . . . b b b b b b . . . . 
        ...
        . . b 5 5 b 5 1 1 1 5 d 4 1 . . 
        . . b d 5 5 b 1 1 1 5 4 4 1 . . 
        b b d b 5 5 5 1 1 1 4 4 4 4 4 b 
        b d d c d 5 5 b 5 4 4 4 4 4 b . 
        c d d d c c b 5 5 5 5 5 5 5 b . 
        c b d d d d d 5 5 5 2 5 5 2 b . 
        . c d d d d d d 5 5 5 2 2 d b . 
        . . c b d d d d d 5 5 5 b b . . 
        . . . c c c c c c c c b b . . . 
        `, SpriteKind.Enemy)
    GRAZIE_GIBBO_PER_LEDITING.setVelocity(-100, 0)
    GRAZIE_GIBBO_PER_LEDITING.setPosition(180, randint(0, 120))
})
